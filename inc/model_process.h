...
public:
    ...
    * @return result
    */
    Result LoadEncryptedModel(const char *modelPath);
    ...
    */
    ...
    /**
    * @brief encrypt the weight partition of the model
    * @param [in] modelPath: model path
    * @return result
    */
    Result EncryptModelWeightAndSave(const char *modelPath);

    /**
    * @brief decrypt the weight partition of the model
    * @param [in] modelPath: model path
    * @return result
    */
    Result DecryptModelWeight();
...
private:
    ...
    bool encryptFlag_; // model encrypted flag
